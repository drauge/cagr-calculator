...
function simulate(model) {
  ...
  for (let year = model.projectionStartYear; year <= model.projectionEndYear; year += 1) {
    ...
    const etfEndValueAfterTaxReal = nlInflationFactorJan1 > 0 ? etfEndValueAfterTax / nlInflationFactorJan1 : etfEndValueAfterTax;
    const propertyEquityJan1Real = ltInflationFactorJan1 > 0 ? propertyEquityJan1 / ltInflationFactorJan1 : propertyEquityJan1;
    const endOfYearNetValue = etfEndValueAfterTax + propertyEquityJan1;
    const endOfYearNetValueReal = etfEndValueAfterTaxReal + propertyEquityJan1Real;
